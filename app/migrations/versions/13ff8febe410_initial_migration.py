...
def downgrade() -> None:
    ...
    op.add_column('appointments', sa.Column('services', sa.UUID(), autoincrement=False, nullable=True))
    op.add_column('appointments', sa.Column('date_created', sa.DATE(), autoincrement=False, nullable=False))
    op.create_foreign_key('appointments_service_id_fkey', 'appointments', 'services', ['services'], ['services'])
    # ### end Alembic commands ###
